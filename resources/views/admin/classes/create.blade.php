        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-2xl font-bold mb-6">Dodaj oddział</h1>
                    ...
                    <form action="{{ route('admin.classes.store') }}" method="POST" class="max-w-lg space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block w-full mt-1" required maxlength="10" placeholder="np. 1A">
                        </div>
                        <div>
                            <label class="block font-medium text-sm text-gray-700">Rok</label>
                            <input type="text" name="year" value="{{ old('year') }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block w-full mt-1" required maxlength="9" placeholder="np. 2025/2026">
                        </div>
