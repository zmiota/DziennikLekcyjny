            ...
            <div class="bg-white shadow-lg sm:rounded-lg overflow-hidden border border-gray-200">
                ...
                <div class="p-6 bg-white border-b border-gray-200 flex justify-between items-center">
                    ...
                    <a href="{{ route('admin.classes.create') }}" 
                       ...
                       style="background-color: #059669;"> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div class="flex justify-end gap-2">
                                            ...
                                            <form action="{{ route('admin.classes.destroy', $class) }}" method="POST" class="inline-block">
                                                ...
                                                <button type="submit" 
                                                        ...
                                                        onclick="return confirm('Na pewno usunąć?')" title="Usuń">
                                                    Usuń
                                                </button>
                                            </form>
                                        </div>
