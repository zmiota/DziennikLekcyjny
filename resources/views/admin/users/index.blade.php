        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg sm:rounded-lg overflow-hidden">
                <div class="p-6 bg-white border-b border-gray-200 flex justify-between items-center">
                    <h1 class="text-2xl font-bold text-gray-800">Lista użytkowników</h1>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left font-bold text-gray-600 uppercase tracking-wider border-r border-gray-200">Rola</th>
                        ...
                        @foreach($users as $user)
                            <tr class="hover:bg-blue-50 transition duration-150 ease-in-out even:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-gray-500 border-r border-gray-200 font-mono">{{ $user->id }}</td>
                                <td class="px-6 py-4 whitespace-nowrap font-semibold text-gray-800 border-r border-gray-200">{{ $user->name }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-600 border-r border-gray-200">{{ $user->email }}</td>
                                    ...
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST" class="inline-block">
                                            ...
                                            <button type="submit" 
                                                    ...
                                                    onclick="return confirm('Na pewno chcesz usunąć?')" title="Usuń">
                                                Usuń
                                            </button>
                                        </form>
                                    </div>
